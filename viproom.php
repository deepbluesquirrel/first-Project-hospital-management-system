...
if(isset($_POST['submit']))
{
	...
	$check4=mysqli_query($conn,"select id from casualty where id='$i'");
	if(!empty($r0))
	{	
...
if(isset($_POST['delete']))
{
		...
		$dep='VIP';
		$test = mysqli_query($conn,"select id from patientreg where id='$i'");
		$test1 = mysqli_query($conn,"select id from vip where id='$i'");
		$r0 = mysqli_fetch_row($test);
...
if(isset($_POST['hide']))
{
	$result = mysqli_query($conn,"SELECT * FROM `totalroom` WHERE roomno1 not in(SELECT roomno FROM vroom) AND section='VIP'");
